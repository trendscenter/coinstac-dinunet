...
setup(
    ...
    version="0.1",
    description="Neural Network implementation for COINSTAC.",
    ...
    packages=['coinstac_dinunet', 'coinstac_dinunet.config', 'coinstac_dinunet.data', 'coinstac_dinunet.metrics', 'coinstac_dinunet.nodes', 'coinstac_dinunet.utils', 'coinstac_dinunet.vision'],
